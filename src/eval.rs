...
mod test {
    ...
    fn test_operator() {
        ...
        check("3 and 0", Value::Number(3.0));
        check("0 or 5", Value::Number(5.0));
        ...
        check("0 and 0 or 0 or 4", Value::Number(0.0));
        check("0 and 0 or 0 or 0", Value::Number(0.0));
    ...
    fn test_lambda() {
        ...
        check("(x => y => 2 => x+y+z)(1)(2)(3)", Value::Number(6.0));
        check("((x,y) => x + y) (1, 2)", Value::Number(3.0));
    }
}
